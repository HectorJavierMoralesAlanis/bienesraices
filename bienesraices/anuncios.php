...
?>
    ...
    <main class="contenedor seccion">
        ...
        <div class="contenedor-anuncios">
            ...
            <div class="anuncio">
                <picture>
                    <img loading="lazy" src="/bienesraices/retornoImagen.php?s_id=<?php echo $propiedad["imagen"]?>"  alt="<?php echo $propeidad["nombre_archivo"] ?>" title="<?php echo $propiedad["nombre_archivo"] ?>">                
                </picture>
